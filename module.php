...
return new class extends AbstractModule implements ModuleCustomInterface, ModuleHistoricEventsInterface {
    ...
    public function historicEventsAll(): Collection
    {
        return new Collection([
            ...
            "1 EVEN Louis Botha\n2 TYPE Prime minister\n2 DATE FROM 31 MAY 1910 TO 27 AUG 1919\n2 NOTE Source: [Wikipedia](https://en.wikipedia.org/wiki/Prime_Minister_of_South_Africa)",
            ...
            "1 EVEN Pieter Willem Botha\n2 TYPE Executive President\n2 DATE FROM 14 SEP 1984 TO 15 AUG 1989\n2 NOTE Source: [Wikipedia](https://en.wikipedia.org/wiki/State_President_of_South_Africa#List_of_state_presidents_of_South_Africa)",
            ...
            "1 EVEN Nelson Rolihlahla Mandela\n2 TYPE President\n2 DATE FROM 10 MAY 1994 TO 14 JUN 1999\n2 NOTE Source: [Wikipedia](https://en.wikipedia.org/wiki/President_of_South_Africa#Presidents_of_South_Africa_(1994%E2%80%93present))",
